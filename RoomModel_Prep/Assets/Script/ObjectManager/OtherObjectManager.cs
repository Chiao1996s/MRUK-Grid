...
{
    public List<MRUKAnchor> others = new List<MRUKAnchor>();
    ...
    public void OtherObjectBloc()
    {
        ...
        {
            Vector3[] points = others[i].GetBoundsFaceCenters();
            ...
            switch (i)
            {
                ...
                case 2:
                    ...
                    break;
                default:
                    Debug.LogWarning("More than 3 others found, no prefab assigned for table index: " + i);
                    break;
            }
