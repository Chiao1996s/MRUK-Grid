...
{
    public List<MRUKAnchor> screens = new List<MRUKAnchor>();
    ...
    public void ScreenBloc()
    {
        ...
        {
            Vector3[] points = screens[i].GetBoundsFaceCenters();
            ...
            switch (i)
            {
                ...
                case 2:
                    ...
                    break;
                default:
                    Debug.LogWarning("More than 3 screens found, no prefab assigned for table index: " + i);
                    break;
            }
