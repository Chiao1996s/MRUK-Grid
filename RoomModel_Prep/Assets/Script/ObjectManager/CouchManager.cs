...
{
    public List<MRUKAnchor> couches = new List<MRUKAnchor>();
    ...
    public void CouchBloc()
    {
        ...
        {
            Vector3[] points = couches[i].GetBoundsFaceCenters();
            ...
            switch (i)
            {
                ...
                case 2:
                    ...
                    break;
                default:
                    Debug.LogWarning("More than 3 couches found, no prefab assigned for table index: " + i);
                    break;
            }
