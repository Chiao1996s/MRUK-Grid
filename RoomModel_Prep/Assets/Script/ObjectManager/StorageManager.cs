...
{
    public List<MRUKAnchor> storages = new List<MRUKAnchor>();
    ...
    public void StorageBloc()
    {
        ...
        {
            Vector3[] points = storages[i].GetBoundsFaceCenters();
            ...
            switch (i)
            {
                ...
                case 2:
                    ...
                    break;
                default:
                    Debug.LogWarning("More than 3 storages found, no prefab assigned for table index: " + i);
                    break;
            }
