...
{
    public List<MRUKAnchor> tables = new List<MRUKAnchor>();
    ...
    public void TableBloc()
    {
        ...
        {
            Vector3[] points = tables[i].GetBoundsFaceCenters();
            ...
            switch (i)
            {
                ...
                case 2:
                    ...
                    break;
                default:
                    Debug.LogWarning("More than 3 tables found, no prefab assigned for table index: " + i);
                    break;
            }
